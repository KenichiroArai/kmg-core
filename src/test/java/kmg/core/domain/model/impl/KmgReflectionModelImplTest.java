...
public class KmgReflectionModelImplTest {
    ...
    /**
     * getMethodInvoke メソッドのテスト - パラメータタイプを指定したメソッド呼び出しのエラー<br>
     *
     * @throws KmgDomainException
     *                            KMGドメイン例外
     */
    @Test
    @SuppressWarnings("static-method")
    public void testGetMethodInvoke_withParameterTypesError() throws KmgDomainException {
        ...
        /* 検証の実施 */
        Assertions.assertEquals(expectedValue, actualValue, "誤ったパラメータタイプを指定した場合、nullが返されること");
