...
public class KmgCoreValMsgTypesTest {
    ...
    public void testGet_normalBasicValue() {
        ...
        /* 準備 */
        final KmgCoreValMsgTypes testType = KmgCoreValMsgTypes.NONE;
    ...
    public void testGetDefault_normalDefaultValue() {
        ...
        /* 期待値の定義 */
        final KmgCoreValMsgTypes expected = KmgCoreValMsgTypes.NONE;

        /* テスト対象の実行 */
        final KmgCoreValMsgTypes actual = KmgCoreValMsgTypes.getDefault();
    ...
    public void testGetEnum_normalExistingValue() {
        ...
        /* テスト対象の実行 */
        final KmgCoreValMsgTypes actual = KmgCoreValMsgTypes.getEnum(key);
    ...
    public void testGetEnum_semiNonExistingValue() {
        ...
        /* テスト対象の実行 */
        final KmgCoreValMsgTypes actual = KmgCoreValMsgTypes.getEnum(testValue);
    ...
    public void testGetInitValue_normalInitialValue() {
        ...
        /* テスト対象の実行 */
        final KmgCoreValMsgTypes actual = KmgCoreValMsgTypes.getInitValue();
