...
public class KmgMessageUtilsTest {
    ...
    public void testGetMessage_errorArgsNull() {
        ...
        /* テスト対象の実行 */
        final String testResult = KmgMessageUtils.getMessage(KmgGenMessageTypes.KMGMSGE11100, null);
    ...
    public void testGetMessage_errorArgumentMismatch() {
        ...
        /* テスト対象の実行 */
        final String testResult = KmgMessageUtils.getMessage(KmgGenMessageTypes.KMGMSGE11200, testArgs);
    ...
    public void testGetMessage_errorMessagePatternNull() {
        ...
        final KmgCommonGenMessageTypes mockType = new KmgCommonGenMessageTypes() {
    ...
    public void testGetMessage_normalCase() {
        ...
        /* テスト対象の実行 */
        final String testResult = KmgMessageUtils.getMessage(KmgGenMessageTypes.KMGMSGE11100, testArgs);
    ...
    public void testGetMessagePattern_errorNullKey() {
        ...
        /* 準備 */
        // nullを返すgetKeyを持つKmgCommonGenMessageTypesの実装
        final KmgCommonGenMessageTypes mockType = new KmgCommonGenMessageTypes() {
