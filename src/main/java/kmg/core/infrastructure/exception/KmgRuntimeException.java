...
public class KmgRuntimeException extends RuntimeException {
     ...
     *                     メッセージの種類
     */
    public KmgRuntimeException(final KmgComExcMessageTypes messageTypes) {
     ...
     *                     メッセージの引数
     */
    public KmgRuntimeException(final KmgComExcMessageTypes messageTypes, final Object[] messageArgs) {
     ...
     *                     原因
     */
    public KmgRuntimeException(final KmgComExcMessageTypes messageTypes, final Throwable cause) {
